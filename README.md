...
一种比较快的手动猜测方法是，找到还差两个 0 或者 1 没填的行、列，根据排列组合的知识，假设总共还有 n 个空没填，则只有 $C(n, 2)$，即 $n*(n-1)/2$ 种可能，一般来说最多也就 10 种，做一些尝试即可。经验证，通过这样的方法，可以解出所有里程碑 20 之前的题目（里程碑 20 我还没全部解锁哈哈哈）。
